...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_routes2.default, document.getElementById('app')); // var USER_DATA = {
	//   name: 'Weinan Qiu',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PromptContainer = __webpack_require__(233);

	var _PromptContainer2 = _interopRequireDefault(_PromptContainer);

	var _ConfirmBattleContainer = __webpack_require__(235);

	var _ConfirmBattleContainer2 = _interopRequireDefault(_ConfirmBattleContainer);

	var _ResultsContainer = __webpack_require__(258);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function MainContainer(props) {
	  return _react2.default.createElement(
	    'div',
	    { className: 'jumbotron col-sm-12 text-center', style: _styles.transparentBg },
	    props.children
	  );
	}
...
/***/ function(module, exports) {
	...
	var transparentBg = exports.transparentBg = { background: 'transparent' };
	var space = exports.space = { marginTop: '25px' };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PromptContainer = _react2.default.createClass({
	  displayName: 'PromptContainer',

	  contextTypes: {
	    router: _react2.default.PropTypes.object.isRequired // direct access this.context without going on param hierarchy
	  },
	  getInitialState: function getInitialState() {
	    return {
	      username: ''
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Prompt(props) {
	  return _react2.default.createElement(
	    'div',
	    { className: 'jumbotron col-sm-6 col-sm-offset-3 text-center', style: _styles.transparentBg },
	    _react2.default.createElement(
	      'h1',
	      null,
	      props.header
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ConfirmBattle = __webpack_require__(236);

	var _ConfirmBattle2 = _interopRequireDefault(_ConfirmBattle);

	var _githubHelpers = __webpack_require__(240);
	...
	var ConfirmBattleContainer = _react2.default.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    (0, _githubHelpers.getPlayersInfo)([query.playerOne, query.playerTwo]).then(function (players) {
	      this.setState({
	        isLoading: false,
	        playersInfo: [players[0], players[1]]
	      });
	    }.bind(this)); // bind external context to the function invokation
	  },
	  handleInitiateBattle: function handleInitiateBattle() {
	    this.context.router.push({
	      pathname: '/results',
	      state: {
	...
	exports.default = ConfirmBattleContainer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UserDetailsWrapper = __webpack_require__(238);

	var _UserDetailsWrapper2 = _interopRequireDefault(_UserDetailsWrapper);
	...
	function ConfirmBattle(props) {
	  return props.isLoading === true ? _react2.default.createElement(_Loading2.default, { speed: 500, text: 'Wait one moment' }) : _react2.default.createElement(
	    _MainContainer2.default,
	    null,
	    _react2.default.createElement(
	      'h1',
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        _UserDetailsWrapper2.default,
	        { player: 'Player 1' },
	        _react2.default.createElement(_UserDetails2.default, { info: props.playersInfo[0] })
	      ),
	      _react2.default.createElement(
	        _UserDetailsWrapper2.default,
	        { player: 'Player 2' },
	        _react2.default.createElement(_UserDetails2.default, { info: props.playersInfo[1] })
	      )
	    ),
	    _react2.default.createElement(
	      'div',
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'col-sm-12', style: _styles.space },
	        _react2.default.createElement(
	          'button',
	...
	ConfirmBattle.propTypes = {
	  ...
	  playersInfo: _react.PropTypes.array.isRequired,
	  onInitiateBattle: _react.PropTypes.func.isRequired
	};

	exports.default = ConfirmBattle;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function UserDetails(_ref) {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      { className: "list-group-item" },
	      " ",
	      _react2.default.createElement("img", { src: info.avatar_url, className: "img-rounded img-responsive" })
	    ),
	    ...
	    info.location && _react2.default.createElement(
	      "li",
	      { className: "list-group-item" },
	      "Location: ",
	      info.location
	    ),
	    info.company && _react2.default.createElement(
	      "li",
	      { className: "list-group-item" },
	      "Company: ",
	      info.company
	    ...
	    info.blog && _react2.default.createElement(
	      "li",
	      { className: "list-group-item" },
	      "Blog: ",
	      _react2.default.createElement(
	...
	UserDetails.propTypes = {
	  ...
	  info: _react.PropTypes.shape({
	    ...
	    public_repos: _react.PropTypes.number.isRequired
	  })
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserDetailsWrapper = function UserDetailsWrapper(props) {
	  return _react2.default.createElement(
	    "div",
	    { className: "col-sm-6" },
	    _react2.default.createElement(
	...
	UserDetailsWrapper.PropTypes = {
	  player: _react.PropTypes.string.isRequired
	};

	exports.default = UserDetailsWrapper;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function battle(players) {
	  ...
	  return _axios2.default.all([playerOneData, playerTwoData]).then(calculateScores).catch(function (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var btoa = window.btoa || __webpack_require__(251);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Results = __webpack_require__(259);
	...
	var ResultsContainer = _react2.default.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    (0, _githubHelpers.battle)(this.props.location.state.playersInfo).then(function (scores) {
	      this.setState({
	        scores: scores,
	        isLoading: false
	      });
	  ...
	  render: function render() {
	    return _react2.default.createElement(_Results2.default, { playersInfo: this.props.location.state.playersInfo,
	      isLoading: this.state.isLoading,
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Results(props) {
	  if (props.isLoading === true) {
	    return _react2.default.createElement(_Loading2.default, { text: 'One Moment' });
	  }
	  ...
	  if (props.scores[0] === props.scores[1]) {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(StartOver, null)
	    );
	  }
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        _UserDetailsWrapper2.default,
	        { player: 'Winner' },
	        _react2.default.createElement(_UserDetails2.default, { score: props.scores[winningIndex],
	          info: props.playersInfo[winningIndex] })
	      ),
	      _react2.default.createElement(
	        _UserDetailsWrapper2.default,
	        { player: 'Loser' },
	        _react2.default.createElement(_UserDetails2.default, { score: props.scores[losingIndex],
	...
	Results.PropTypes = {
	  playersInfo: _react.PropTypes.array.isRequired,
	  isLoading: _react.PropTypes.bool.isRequired,
	  scores: _react.PropTypes.array.isRequired
	};
